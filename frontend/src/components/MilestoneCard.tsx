...
import { Milestone, Child } from "@/lib/api";
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-brand-100 overflow-hidden">
      <div className="flex gap-0">
        {/* Thumbnail */}
        <div className="w-28 sm:w-36 shrink-0 bg-gray-50 flex items-center justify-center">
          {thumbSrc ? (
            <img
              src={thumbSrc}
              alt={m.label}
        ...
        <div className="flex-1 p-4 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <h3 className="font-semibold text-gray-800 truncate">{m.label}</h3>
          ...
          {/* Child selector (review mode only) */}
